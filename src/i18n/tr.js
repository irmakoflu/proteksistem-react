      ...
      sections: [
        {
          ...
          body: [
            'Bu Gizlilik Politikası, Protek Yazılım Sistem Danışmanlık Bilgisayar Sanayi ve Ticaret Limited Şirketi ("Protek", "biz") tarafından işletilen proteksistem.com web sitesini ziyaret eden kullanıcıların kişisel verilerinin nasıl toplandığını, kullanıldığını ve korunduğunu açıklamak amacıyla hazırlanmıştır.',
          ],
        },
        {
          heading: '2. Toplanan Veriler',
          body: ['Web sitemizi ziyaret ettiğinizde veya iletişim formlarımızı kullandığınızda aşağıdaki veriler işlenebilir:'],
          list: [
            'Ad, soyad, e-posta adresi, telefon numarası gibi iletişim formunda paylaştığınız bilgiler',
            'Site kullanımına ilişkin teknik veriler (IP adresi, tarayıcı bilgisi, ziyaret süresi)',
            'Çerezler aracılığıyla toplanan gezinme verileri',
          ],
        },
        {
          heading: '3. Kullanım Amaçları',
          body: ['Toplanan veriler; taleplerinize yanıt vermek, hizmetlerimiz hakkında bilgi sunmak, web sitesini geliştirmek ve yasal yükümlülüklerimizi yerine getirmek amacıyla kullanılır.'],
        },
        {
          heading: '4. Verilerin Paylaşımı',
          body: ['Kişisel verileriniz, yasal zorunluluklar dışında üçüncü taraflarla paylaşılmaz; yalnızca hizmet sağlayıcılarımızla (ör. e-posta/altyapı sağlayıcıları) sınırlı ve amaçla bağlantılı şekilde paylaşılabilir.'],
        },
        {
          heading: '5. Veri Güvenliği',
          body: ['Kişisel verilerinizin güvenliğini sağlamak amacıyla makul teknik ve idari tedbirler alınmaktadır.'],
        },
        {
          heading: '6. İletişim',
          body: ['Bu politika hakkında sorularınız için iletişim sayfamızdaki kanallardan bize ulaşabilirsiniz.'],
        },
      ],
    },
    kvkk: {
      ...
      sections: [
        {
          ...
          list: [
            ...
            'MERSİS Numarası: [MERSİS numaranızı buraya ekleyin]',
            'Ticaret Sicil Numarası: [Ticaret sicil numaranızı buraya ekleyin]',
            'Ticaret Sicil Müdürlüğü: [Kayıtlı olduğunuz sicil müdürlüğü]',
